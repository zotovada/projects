# Анализ продаж и пользовательской активности сервиса продажи билетов

## Описание проекта
Проект посвящён аналитике данных сервиса продажи билетов за лето–осень 2024 года. Отдел продукта заметил, что продажи билетов на одни мероприятия растут, а на другие снижаются. Причины изменений пока неясны: возможно, это связано с сезонностью, сменой интересов аудитории или особенностями поведения пользователей на разных устройствах. Необходимо предоставить продуктовой команде детальную аналитику для подготовки к зимнему периоду распродаж.  
