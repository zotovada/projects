...
Папки названы таким образом, чтобы сразу было понятно, вокруг какой аналитической задачи построен проект.  
Например, в папке `ab_test` — дизайн, мониторинг и анализ результатов A/B-теста, а в папке `metrics` — расчёт и визуализация метрик продукта.  
...
4. Для SQL-проектов можно открыть запросы в любом SQL-клиенте (например, DBeaver).  
...
**Описание:** Аналитическая поддержка выхода агентства недвижимости на рынок Санкт-Петербурга и Ленинградской области. В проекте решены ad-hoc-задачи с использованием сложных SQL-запросов (CTE).  
...
### 4. `full_analysis`
**Название проекта:** Анализ продаж и пользовательской активности сервиса Яндекс Афиша  
**Описание:** Комплексный анализ данных сервиса Яндекс Афиша за лето–осень 2024 года. Определение факторов, влияющих на продажи билетов, исследование поведения пользователей, подготовка рекомендаций для продуктовой команды.  
...
### 5. `metrics`
**Название проекта:** Расчёт и визуализация ключевых бизнес-метрик  
